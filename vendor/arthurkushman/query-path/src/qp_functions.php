 ...
 */
/* JMP_DBG function qp($document = NULL, $string = NULL, array $options = [])
{
 ...
 */
/* JMP_DBG function htmlqp($document = NULL, $selector = NULL, $options = [])
{
 ...
 * @return QueryPath
 */
/* JMP_DBG function html5qp($document = NULL, $selector = NULL, array $options = [])
{
