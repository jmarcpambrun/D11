...
class __TwigTemplate_f30bc0469a5f9809493ba767a587f0ef extends Template
{
...
$context["group"], "type", [], "any", false, false, true, 31), ["warning", "error"])) ? (("system-status-report__status-icon system-status-report__status-icon--" . CoreExtension::getAttribute($this->env, $this->source, $context["group"], "type", [], "any", false, false, true, 31))) : (""))];
            ...
            ";
                // line 35
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["requirement"], "severity_title", [], "any", false, false, true, 35)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 36
          ...
          <div class=\"system-status-report__entry__value\">
            ...
            ";
                // line 42
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["requirement"], "description", [], "any", false, false, true, 42)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 43
...
";
    ...
    {
        return new Source("", "themes/contrib/seven/templates/status-report-grouped.html.twig", "/var/www/D11/themes/contrib/seven/templates/status-report-grouped.html.twig");
    }
