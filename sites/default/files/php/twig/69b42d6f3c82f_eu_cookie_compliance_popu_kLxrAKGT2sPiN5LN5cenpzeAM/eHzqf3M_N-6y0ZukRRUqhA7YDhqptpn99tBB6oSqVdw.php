...
class __TwigTemplate_972719708cc672f11afaeaaad8aefb55 extends Template
{
...
";
        // line 41
        if ((($tmp = ($context["privacy_settings_tab_label"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 42
...
($context["method"] ?? null)))];
  ...
  <div class=\"popup-content info eu-cookie-compliance-content\">
    ";
        // line 51
        if ((($tmp = ($context["close_button_enabled"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 52
    ...
    ";
      ...
      ";
        // line 56
        if ((($tmp = ($context["more_info_button"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 57
    ...
    ";
        // line 61
        if ((($tmp = ($context["cookie_categories"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 62
        ...
        ";
            ...
            ";
                // line 72
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["category"], "description", [], "any", false, false, true, 72)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 73
        ...
        ";
            ...
            // line 77
            yield "        ";
            if ((($tmp = ($context["save_preferences_button_label"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 78
    ...
    <div id=\"popup-buttons\" class=\"eu-cookie-compliance-buttons";
      ...
      ";
        // line 87
        if ((($tmp = ($context["tertiary_button_label"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 88
      ...
      ";
        // line 91
        if ((($tmp = ($context["secondary_button_label"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 92
            yield "        <button type=\"button\" class=\"";
...
";
    ...
    {
        return new Source("", "modules/contrib/eu_cookie_compliance/templates/eu_cookie_compliance_popup_info.html.twig", "/var/www/D11/modules/contrib/eu_cookie_compliance/templates/eu_cookie_compliance_popup_info.html.twig");
    }
