...
class __TwigTemplate_4527415bb08ee6c17350aa167dee24cb extends Template
{
  ...
  <div class=\"system-status-general-info__items\">
    ...
    <div class=\"system-status-general-info__item\">
      ...
      <div class=\"system-status-general-info__item-details\">
        ...
        ";
        // line 50
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["cron"] ?? null), "run_cron", [], "any", false, false, true, 50)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 51
        ...
        // line 53
        yield "        ";
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["cron"] ?? null), "description", [], "any", false, false, true, 53)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 54
    ...
    <div class=\"system-status-general-info__item\">
      ...
      <div class=\"system-status-general-info__item-details\">
        ...
        ";
        // line 63
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["webserver"] ?? null), "description", [], "any", false, false, true, 63)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 64
            yield "          <div class=\"description\">";
    ...
    <div class=\"system-status-general-info__item\">
      ...
      <div class=\"system-status-general-info__item-details\">
        ...
        ";
        // line 73
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["php"] ?? null), "description", [], "any", false, false, true, 73)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 74
            yield "          <div class=\"description\">";
        ...
        ";
        // line 78
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["php_memory_limit"] ?? null), "description", [], "any", false, false, true, 78)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 79
            yield "          <div class=\"description\">";
    ...
    <div class=\"system-status-general-info__item\">
      ...
      <div class=\"system-status-general-info__item-details\">
        ...
        ";
        // line 88
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["database_system_version"] ?? null), "description", [], "any", false, false, true, 88)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 89
            yield "          <div class=\"description\">";
        ...
        ";
        // line 93
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["database_system"] ?? null), "description", [], "any", false, false, true, 93)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 94
            yield "          <div class=\"description\">";
...
";
    ...
    {
        return new Source("", "themes/contrib/seven/templates/status-report-general-info.html.twig", "/var/www/D11/themes/contrib/seven/templates/status-report-general-info.html.twig");
    }
