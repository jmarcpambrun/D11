...
class WebformGroupUserInterfaceTest extends WebformGroupBrowserTestBase {
  ...
  public function testGroupUserInterfaceAccess() {
    ...
    $assert->responseContains('<label for="edit-access-create-group-roles">Group (node) roles</label>');
    $assert->fieldExists('access[create][group_roles][]');
    ...
    $assert->fieldExists('properties[access_create_group_roles][]');
