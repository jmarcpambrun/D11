...
class DnsLookup {
   ...
   */
  public function lookup(string $name, array &$ipv4, array &$ipv6): void {
    static $results = [];
   ...
   */
  public function ip2long6(string $ipv6): int|string {
    if (!function_exists('gmp_strval')) {
      return 0;
    }
    $ipv6long = '';
