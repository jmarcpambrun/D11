...
use Drupal\drd\Annotation\Update;
...
abstract class Manager extends DefaultPluginManager implements ManagerInterface {
  ...
  /**
   * The list of update plugins.
   *
   * @var array|null
   */
  private ?array $selectList = NULL;
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct($this->getSubDir(), $namespaces, $module_handler, $this->getPluginInterface(), Update::class);
