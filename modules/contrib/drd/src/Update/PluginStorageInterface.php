...
interface PluginStorageInterface extends PluginInterface {
   ...
   */
  public function execute(CoreInterface $core, array $releases, bool $dry, bool $showlog): bool|string;
   ...
   * @return $this
   */
  public function log(array|string $log): self;
   ...
   *   The build plugin.
   */
  public function getBuildPlugin(): PluginBuildInterface;
   ...
   *   The process plugin.
   */
  public function getProcessPlugin(): PluginProcessInterface;
   ...
   *   The test plugin.
   */
  public function getTestPlugin(): PluginTestInterface;
   ...
   *   The deploy plugin.
   */
  public function getDeployPlugin(): PluginDeployInterface;
   ...
   *   The finish plugin.
   */
  public function getFinishPlugin(): PluginFinishInterface;
   ...
   * @return $this
   */
  public function setWorkingDirectory(): self;
   ...
   * @return $this
   */
  public function prepareWorkingDirectory(): self;
   ...
   * @return $this
   */
  public function saveWorkingDirectory(): self;
