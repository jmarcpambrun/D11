...
/**
 * Provides a form for reverting a Project revision for a single trans.
 *
 * @ingroup burndown
 */
class ProjectRevisionRevertTranslationForm extends ProjectRevisionRevertForm {
  ...
  public function getFormId() {
    return 'burndown_project_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $burndown_project_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $burndown_project_revision);
