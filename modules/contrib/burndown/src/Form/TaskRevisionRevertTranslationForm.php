...
class TaskRevisionRevertTranslationForm extends TaskRevisionRevertForm {
  ...
  public function getFormId() {
    return 'burndown_task_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $burndown_task_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $burndown_task_revision);
