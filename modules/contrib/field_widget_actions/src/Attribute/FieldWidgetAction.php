...
class FieldWidgetAction extends Plugin {
   ...
   *   (optional) Deprecated. If TRUE, the button will be shown for each
   *   element of multivalue field. If NULL (default), the attribute property
   *   is not set and no deprecation is triggered.
  ...
  public function __construct(
    ...
    if ($this->multiple !== NULL) {
      @trigger_error('The "multiple" attribute property is deprecated in field_widget_actions:1.3.1 and is removed from field_widget_actions:2.0.0. Use configuration option "multiple" in the plugin instead. See https://www.drupal.org/node/3592722', E_USER_DEPRECATED);
    }
  }
