...
class WebformQuizQuizResultSummary extends RenderElementBase {
  ...
  public static function preRenderWebformQuizResultSummary(array $element) {
    ...
    $show_statistics = @$quiz_settings['show_statistics'] ?? 0;
    $passing_score = @$quiz_settings['passing_score'] ?? WebformQuizWebformSettingsForm::DEFAULT_PASSING_SCORE;
    ...
    $element['result_display']['#markup'] = '<p>' . t(
        'You got @number_correct out of @total right!',
        [
