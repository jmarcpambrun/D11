...
/**
 * Provides funcationality for DivisibleByConstraintFieldValidationRule.
 *
 * @FieldValidationRule(
 *   id = "divisible_by_constraint_rule",
 *   label = @Translation("DivisibleBy constraint"),
 *   description = @Translation("DivisibleBy constraint.")
 * )
 */
class DivisibleByConstraintFieldValidationRule extends ConstraintFieldValidationRuleBase {
