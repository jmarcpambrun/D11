...
/**
 * Provides funcationality for GreaterThanOrEqualConstraintFieldValidationRule.
 *
 * @FieldValidationRule(
 *   id = "greater_than_or_equal_constraint_rule",
 *   label = @Translation("GreaterThanOrEqual constraint"),
 *   description = @Translation("GreaterThanOrEqual constraint.")
 * )
 */
class GreaterThanOrEqualConstraintFieldValidationRule extends ConstraintFieldValidationRuleBase {
