...
/**
 * Provides funcationality for GreaterThanConstraintFieldValidationRule.
 *
 * @FieldValidationRule(
 *   id = "greater_than_constraint_rule",
 *   label = @Translation("GreaterThan constraint"),
 *   description = @Translation("GreaterThan constraint.")
 * )
 */
class GreaterThanConstraintFieldValidationRule extends ConstraintFieldValidationRuleBase {
