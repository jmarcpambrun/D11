...
/**
 * Provides funcationality for IdenticalToConstraintFieldValidationRule.
 *
 * @FieldValidationRule(
 *   id = "identical_to_constraint_rule",
 *   label = @Translation("IdenticalTo constraint"),
 *   description = @Translation("IdenticalTo constraint.")
 * )
 */
class IdenticalToConstraintFieldValidationRule extends ConstraintFieldValidationRuleBase {
